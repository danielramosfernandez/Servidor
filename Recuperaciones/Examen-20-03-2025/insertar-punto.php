<?php
    ...
    if (isset($_POST['input'])) {
        ...
        if ($_POST['input'] == "INCREMENTAR" && $_SESSION['contador']<5) {
            ...
            echo<<<_END
                <meta http-equiv="refresh" content="0;URL='formularios.php'" />
            _END;
        } else {
...
<body>
    ...
    <div style="border: 4px double; width:40%;"> 
        ...
        <p>Hola <?php echo  $_SESSION['usu'];?>, cuantas notas deseas grabar?</p>
        <p>Puedes grabar entre 1 y 5. Por cada pulsación en INCREMENTAR grabarás una nota más.</p>
     ...
     <!--    Hacemos un for que sirva para que cada vez que pulsemos en incrementar 
        ...
        <?php 
            for ($i=1;$i<=$_SESSION['contador']; $i++) {
                echo "<img src='imagenes/OIP$i.gif' style='border: 4px double; width:5%;'>";
            }
        ?>
    </div>

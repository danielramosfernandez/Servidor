...
<head>
        ...
        ?>
            <body>
                <h1>SIMON</h1>
                <h2><?php echo $_SESSION['usu'];?> enhorabunea, has acertado</h2>
                <div class="circulos">
           ...
           <h1>SIMON</h1>
            ...
            <h3>LA COMBINACION CORRECTA  ERA: </h3>
            <div class="circulos">
                <?php  pintar_circulos($_SESSION["solucion"][0], $_SESSION["solucion"][1],$_SESSION["solucion"][2],$_SESSION["solucion"][3]);?>
            </div>
            <h3>TU RESPUESTA: </h3>
                ...
                <a href="estadistica.php?usario=<?php echo $_SESSION['usu']; ?>">Estadistica</a> 
            </body>
            </html> 
            <?php
        } 
